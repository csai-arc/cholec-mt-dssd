...
def do_train(cfg, model,
    ...
    if args.use_tensorboard and save_to_disk:
        ...
        #import tensorboardX
        summary_writer = SummaryWriter(log_dir=os.path.join(cfg.OUTPUT_DIR, 'tb_logs'))
    ...
    for iteration, (images, targets, _) in enumerate(data_loader, start_iter):
        ...
        if iteration % args.log_step == 0:
            ...
            if summary_writer:
                ...
                #print(images.size)
                #print(images.size())
                #images_new=images.detach().numpy()
                #summary_writer.add_graph(model.eval(),images)
